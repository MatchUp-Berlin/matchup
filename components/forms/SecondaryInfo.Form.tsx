  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.switchRow}>
        ...
        <Switch callback={() => setDoesCost(!doesCost)} />
      </div>
      {doesCost && (
        <div className={styles.costRow}>
          ...
          <input
            ...
            placeholder="0.00€"
            onChange={(e) => props.setTotalCost(Number(e.target.value))}
      ...
      <div className={styles.switchRow}>
        <p style={{ color: colors.text[60] }}>Do you want to upload a cover image?</p>
        <Switch callback={() => setHasCustomPic(!hasCustomPic)} />
      </div>
