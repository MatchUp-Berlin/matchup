...
// Button to Modal on Event details page only shows when user is organizer and event is in the past

export interface IConfirmJoinModalProps {
  matchUp: MatchUp;
}

const ConfirmAttendanceModal: React.FunctionComponent<
  IConfirmJoinModalProps
> = (props) => {
    ...
    <div className={styles.modalWrapper}>
      ...
      >
        ...
        <div className={styles.modalInfo}>
          <h2 style={{ color: colors.text[100] }}>Confirm</h2>
        </div>
        <Button
          variant='primary'
