...
const DescriptionModal: React.FunctionComponent<IDescriptionModalProps> = (props) => {
    ...
    <>
      ...
      >
        ...
        <div className={styles.scrollable}>
          <p style={{ color: colors.text[100], fontSize: '1em' }}>{props.description}</p>
        </div>
      </div>
    </>
  );
...
return (
  <>
    ...
    {display && (
      <DescriptionModal participants={participants} close={() => setDisplay(false)}></DescriptionModal>
    )}
  </>
);
