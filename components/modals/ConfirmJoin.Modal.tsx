      ...
      >
        ...
        {!props.isSignedUp && !props.isWithin24Hours && (
          <>
            ...
            <p style={{ color: colors.text[100] }}>
              You will get the deposit back once the organizer confirms your attendance. In case you cannot
              make it, you can cancel the MatchUp up to 24 hours in advance and get your deposit back. If you
              don&apos;t show up or cancel later, your deposit will be donated to one of our local charities.
            </p>
          </>
        )}
        ...
        {!props.isSignedUp && props.isWithin24Hours && (
          <>
            ...
            <p style={{ color: colors.text[100] }}>
              This MatchUp starts within 24 hours. You will get the deposit back once the organizer confirms
              your attendance. If you cancel or not show up your deposit will be donated to one of our local
              charities.
            </p>
          </>
        )}
        ...
        {props.isSignedUp && !props.isWithin24Hours && (
          <>
            <p style={{ color: colors.text[100] }}>If you cancel now you will get back your deposit.</p>

            <p style={{ color: colors.text[100] }}>
              If you don&apos;t cancel within 24 hours in advance or if you don&apos;t show up to the MatchUp,
              you will donate your deposit to one of our local charities.
            </p>
          </>
        )}
        ...
        {props.isSignedUp && props.isWithin24Hours && (
          <>
            <p style={{ color: colors.text[100] }} className={styles.modalCommitText}>
              The MatchUp starts within 24 hours. If you cancel now, you donate your deposit to one of our
              local charities.
            </p>
          </>
        )}

        <a style={{ color: colors.primary[100] }} className={styles.modalPolicyLink}>
          Read more about our local charities and commitment policy
        </a>
        <Button
          variant="primary"
          callback={props.isSignedUp ? () => handleCancel() : () => handleCommit()}
          text={!props.isSignedUp ? 'Commit' : props.isWithin24Hours ? 'Donate 5€' : 'Cancel'}
          disabled={false}
        ></Button>
      </div>
    </div>
