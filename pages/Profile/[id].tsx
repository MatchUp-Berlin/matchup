        ...
        data && (
          <section className={styles.contentWrapper}>
            ...
            <div className={styles.profileMainInfo}>
              <h2>Hi, my name is {data.givenName}</h2>
              <div
              ...
              >
                <div className={styles.singleStat}>
                  ...
                  <p>Joined in {moment(data.createdAt).format('YYYY')}</p>
                </div>
                <div className={styles.singleStat}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                  ...
                  <p>Organized HARDCODED MatchUps</p>
                </div>
                <div className={styles.singleStat}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                  ...
                  <p>Participated to {data.signups.items.length} MatchUps</p>
                </div>
              </div>
            </div>
            <Divider />
