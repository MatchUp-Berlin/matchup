...
const ProfileDetailPage: NextPage = () => {
  ...
  const {
    ...
    () => {
      ...
      return getNumAttendedMatchUps(id as string);
    },
    { enabled: !!id }
  );
            ...
            <div className={styles.profileMainInfo}>
              ...
              >
                ...
                <div className={styles.singleStat}>
                  ...
                  <p style={{ color: colors.text['60'] }}>
                    Participated to {attendedCountData || 0} MatchUps
                  </p>
                </div>
              </div>
            </div>
                  ...
                  data.signups.items.map((signup) => {
                    ...
                    return (
                      <MatchUpCard
                        ...
                        organizerId={signup.organizerId}
                        sportCategory={signup.sportCategory}
                        skillLevel={signup.skillLevel}
                        totalCost={signup.totalCost}
                        reservedCourt={signup.reservedCourt}
                        attendanceMin={signup.attendanceMin}
                        attendanceMax={signup.attendanceMax}
                        cancelled={signup.cancelled}
                        description={signup.description}
                        image={signup.image}
                        date={signup.date}
                        currency={signup.currency}
                        updates={signup.updates}
                        watchList={signup.watchList}
